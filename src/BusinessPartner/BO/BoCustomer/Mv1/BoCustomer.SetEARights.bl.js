...
if(me.getBoBpaMeta().getId() == "Hospital") {
  ...
  acl.removeRight(AclObjectType.PROPERTY, "calle", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "num_exterior", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "numero_interior", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "colonia", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "codigo_postal", AclPermission.VISIBLE);
  ...
  acl.removeRight(AclObjectType.PROPERTY, "email", AclPermission.VISIBLE);
  ...
  acl.removeRight(AclObjectType.PROPERTY, "zona", AclPermission.VISIBLE);
  ...
  acl.removeRight(AclObjectType.PROPERTY, "sociedad", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "canal_de_distribucion", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "organización_de_ventas", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "sector", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "grupo_de_clientes", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "grupo_de_precios", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "condicion_de_pago", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "via_de_pago", AclPermission.VISIBLE);
  ...
  acl.removeRight(AclObjectType.PROPERTY, "condicion_de_pago", AclPermission.VISIBLE);
  acl.removeRight(AclObjectType.PROPERTY, "via_de_pago", AclPermission.VISIBLE);
}else if(me.getBoBpaMeta().getId() == "Farmacias Farma Dumy para pruebas en tableta") {
